...
const KamnaHerbs = () => {
  return (
    <>
      <Header />
      <section className="container mx-auto mt-18 flex h-[70vh] flex-col items-center justify-center bg-[url('/img/kamna-herbs.jpg')] bg-cover bg-center px-4 lg:px-22">
        ...
        <h1 className="text-2xl font-bold text-emerald-700 lg:text-6xl">Kamna Herbs</h1>
      </section>
