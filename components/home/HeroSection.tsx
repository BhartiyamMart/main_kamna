...
export default function HeroSection() {
  return (
    <section id="home" className="relative overflow-hidden bg-white pt-12 pb-16 sm:pt-16 sm:pb-24 lg:pt-0 lg:pb-32">
      {/* Left edge - Cyan/Blue solid gradient orb - Responsive sizing */}
      <div
        className="animate-float absolute top-10 -left-32 h-[250px] w-[250px] rounded-full opacity-26 sm:h-[350px] sm:w-[350px] md:top-16 md:-left-40 md:h-[400px] md:w-[400px] lg:top-20 lg:-left-48 lg:h-[500px] lg:w-[500px]"
        style={{
      ...
      <div
        className="animate-float-delayed absolute top-20 -right-32 h-[250px] w-[250px] rounded-full opacity-40 sm:h-[350px] sm:w-[350px] md:top-24 md:-right-40 md:h-[400px] md:w-[400px] lg:top-82 lg:-right-48 lg:h-[400px] lg:w-[400px]"
        style={{
          background: 'radial-gradient(circle at 40% 40%, #E0F7FF, #4DD0E1, #00BCD4)',
        }}
      />
