  ...
  <div className="relative container mx-auto h-96 bg-gray-50 px-20 lg:h-48">
    <div className="absolute -top-20 right-0 left-0 mx-auto w-full max-w-7xl rounded-lg bg-white p-0">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        ...
        {/* Card 1 */}
        <Link href="our-business/kamna-cafe" className="group relative flex h-28 sm:h-52 items-center justify-center overflow-hidden bg-[#3ea8b6]">
          ...
          <h2 className="relative z-10 text-2xl sm:text-3xl text-white transition-colors duration-500 group-hover:text-white">
            Kamna Cafe
          </h2>
        </Link>
        ...
        {/* Card 3 */}
        <Link href="/kamna-digital" className="group relative flex h-28 sm:h-52 items-center justify-center overflow-hidden bg-[#3ea8b6]">
